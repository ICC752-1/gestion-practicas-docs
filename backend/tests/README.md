...
| --- | --- | --- | --- | ---: | --- |
| CU-U-AD-01 | Unitaria | Admin | Resumen administrativo conserva totales y estados | 2 | [`modules/admin/admin-unitarias.md`](modules/admin/admin-unitarias.md) |
| CU-U-AD-02 | Unitaria | Admin | Listados administrativos conservan datos relevantes | 4 | [`modules/admin/admin-unitarias.md`](modules/admin/admin-unitarias.md) |
| CU-U-AD-03 | Unitaria | Admin | Filtros normalizados del dashboard agrupan estados funcionales | 1 | [`modules/admin/admin-unitarias.md`](modules/admin/admin-unitarias.md) |
| CU-U-AD-04 | Unitaria | Admin | Detalle administrativo de práctica existente o inexistente | 2 | [`modules/admin/admin-unitarias.md`](modules/admin/admin-unitarias.md) |
| CU-U-AD-05 | Unitaria | Admin | Actualización de requisito académico registra trazabilidad | 1 | [`modules/admin/admin-unitarias.md`](modules/admin/admin-unitarias.md) |
| CU-U-AD-06 | Unitaria | Admin | Reportes agregados respetan alcance por rol y carrera | 3 | [`modules/admin/admin-unitarias.md`](modules/admin/admin-unitarias.md) |
| CU-U-AD-07 | Unitaria | Admin | Exportación CSV de reportes omite campos personales | 1 | [`modules/admin/admin-unitarias.md`](modules/admin/admin-unitarias.md) |
| CU-U-AD-08 | Unitaria | Admin | Seguro escolar por solicitud respeta estado y anulación | 2 | [`modules/admin/admin-unitarias.md`](modules/admin/admin-unitarias.md) |
| CU-U-AD-09 | Unitaria | Admin | Requisito institucional histórico de seguro escolar aplica solo a estudiantes | 4 | [`modules/admin/admin-unitarias.md`](modules/admin/admin-unitarias.md) |
...
| CU-U-AU-04 | Unitaria | Auth | Refresh token válido rota sesión y revoca token anterior | 1 | [`modules/auth/auth-unitarias.md`](modules/auth/auth-unitarias.md) |
| CU-U-AU-05 | Unitaria | Auth | Refresh rechaza tokens inválidos o no vigentes | 3 | [`modules/auth/auth-unitarias.md`](modules/auth/auth-unitarias.md) |
| CU-U-AU-06 | Unitaria | Auth | Refresh rechaza usuario inexistente o inactivo | 2 | [`modules/auth/auth-unitarias.md`](modules/auth/auth-unitarias.md) |
...
| CU-I-AU-04 | Integración | Auth | Controller de logout revoca sesión y limpia cookie | 2 | [`modules/auth/auth-integracion.md`](modules/auth/auth-integracion.md) |
...
| CU-U-DO-07 | Unitaria | Documents | Revisión documental respeta comentario obligatorio y trazabilidad | 3 | [`modules/documents/documents-unitarias.md`](modules/documents/documents-unitarias.md) |
| CU-U-DO-08 | Unitaria | Documents | Eliminación lógica respeta estado y rol | 2 | [`modules/documents/documents-unitarias.md`](modules/documents/documents-unitarias.md) |
| CU-U-DO-09 | Unitaria | Documents | Paquete DIRAE exportable exige condiciones completas | 7 | [`modules/documents/documents-unitarias.md`](modules/documents/documents-unitarias.md) |
| CU-U-DO-10 | Unitaria | Documents | Paquete DIRAE selecciona documentos vigentes y últimos aprobados | 4 | [`modules/documents/documents-unitarias.md`](modules/documents/documents-unitarias.md) |
| CU-U-DO-11 | Unitaria | Documents | Paquete DIRAE protege datos sensibles y acceso | 7 | [`modules/documents/documents-unitarias.md`](modules/documents/documents-unitarias.md) |
| CU-U-DO-12 | Unitaria | Documents | Exportación de expediente para DIRAE genera CSV y auditoría estructurada | 6 | [`modules/documents/documents-unitarias.md`](modules/documents/documents-unitarias.md) |
| CU-U-DO-13 | Unitaria | Documents | Contrato ORM documental mantiene columnas y enums críticos | 3 | [`modules/documents/documents-unitarias.md`](modules/documents/documents-unitarias.md) |
| CU-I-DO-01 | Integración | Documents | Descarga HTTP exige autenticación y respeta propietario | 3 | [`modules/documents/documents-integracion.md`](modules/documents/documents-integracion.md) |
| CU-I-DO-02 | Integración | Documents | Controller transforma upload multipart hacia metadata documental | 1 | [`modules/documents/documents-integracion.md`](modules/documents/documents-integracion.md) |
...
| CU-U-IN-05 | Unitaria | Internships | Permitir Práctica I con inducción aprobada | 2 | [`modules/internships/internships-unitarias.md`](modules/internships/internships-unitarias.md) |
| CU-U-IN-06 | Unitaria | Internships | Bloquear Práctica II sin Práctica I aprobada | 1 | [`modules/internships/internships-unitarias.md`](modules/internships/internships-unitarias.md) |
| CU-U-IN-07 | Unitaria | Internships | Permitir Práctica II con Práctica I aprobada o excepción | 2 | [`modules/internships/internships-unitarias.md`](modules/internships/internships-unitarias.md) |
| CU-U-IN-08 | Unitaria | Internships | Validar secuencialidad de Tesis | 3 | [`modules/internships/internships-unitarias.md`](modules/internships/internships-unitarias.md) |
| CU-U-IN-09 | Unitaria | Internships | Validar regla de Práctica Controlada y ramo paralelo | 2 | [`modules/internships/internships-unitarias.md`](modules/internships/internships-unitarias.md) |
| CU-U-IN-10 | Unitaria | Internships | Validar aprobación normal versus aprobación directa | 5 | [`modules/internships/internships-unitarias.md`](modules/internships/internships-unitarias.md) |
| CU-U-IN-11 | Unitaria | Internships | Impedir acciones sobre estados terminales | 5 | [`modules/internships/internships-unitarias.md`](modules/internships/internships-unitarias.md) |
| CU-U-IN-12 | Unitaria | Internships | Rechazo y derivación deben exigir comentario | 4 | [`modules/internships/internships-unitarias.md`](modules/internships/internships-unitarias.md) |
...
| CU-U-PL-04 | Unitaria | Presentation letters | Contexto DOCX conserva campos textuales de plantilla | 1 | [`modules/presentation-letters/presentation-letters-unitarias.md`](modules/presentation-letters/presentation-letters-unitarias.md) |
| CU-U-PL-05 | Unitaria | Presentation letters | Generación falla con error claro si no hay plantilla activa | 1 | [`modules/presentation-letters/presentation-letters-unitarias.md`](modules/presentation-letters/presentation-letters-unitarias.md) |
| CU-U-PL-06 | Unitaria | Presentation letters | Descarga autenticada respeta propiedad de la carta | 2 | [`modules/presentation-letters/presentation-letters-unitarias.md`](modules/presentation-letters/presentation-letters-unitarias.md) |
...
| `modules/data-portability/data-portability-unitarias.md` | Casos unitarios del módulo `data_portability`. |
| `modules/documents/documents-unitarias.md` | Casos unitarios del módulo `documents`. |
| `modules/documents/documents-integracion.md` | Casos de integración del módulo `documents`. |
| `modules/documents/documents-end-to-end.md` | Flujos end-to-end documentados del módulo `documents`. |
| `modules/internships/internships-unitarias.md` | Casos unitarios del módulo `internships`. |
| `modules/internships/internships-integracion.md` | Casos de integración del módulo `internships`. |
| `modules/internships/internships-end-to-end.md` | Flujos end-to-end documentados del módulo `internships`. |
| `modules/notifications/notifications-unitarias.md` | Casos unitarios del módulo `notifications`. |
| `modules/notifications/notifications-integracion.md` | Casos de integración del módulo `notifications`. |
| `modules/notifications/notifications-end-to-end.md` | Flujos end-to-end documentados del módulo `notifications`. |
| `modules/presentation-letters/presentation-letters-unitarias.md` | Casos unitarios del módulo `presentation_letters`. |
| `modules/scheduling/scheduling-unitarias.md` | Casos unitarios del módulo `scheduling`. |
| `modules/self-evaluations/self-evaluations-unitarias.md` | Casos unitarios del módulo `self_evaluations`. |
| `modules/supervisor-evaluations/supervisor-evaluations-unitarias.md` | Casos unitarios del módulo `supervisor_evaluations`. |
